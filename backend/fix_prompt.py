...
with open('d:/Desktop/chat-with-all/backend/app/llm/prompts/runtime.py', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('d:/Desktop/chat-with-all/backend/app/llm/prompts/runtime.py', 'w', encoding='utf-8') as f:
    f.write(new_content)
