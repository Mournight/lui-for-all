...
- Base URL: `http://sample-fastapi:8010`
- OpenAPI URL: `http://sample-fastapi:8010/openapi.json`
...
- Base URL: `http://sample-node:8020`
- OpenAPI URL: `http://sample-node:8020/openapi.json`
- 登录接口 route_id: `POST:/api/auth/login`
- 用户名字段: `username`
- 密码字段: `password`
